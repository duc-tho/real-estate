...
<p><div class="container-fluid w90">
		...
		<div class="col-sm-6 col-md-6 colm10 itemduan">
			<div class="hourseitem row">
				<div class="blii col-sm-6 col-md-6 colm10">
					<div class="img">
						<img data-src="https://flex-home.botble.com/storage/properties/t3-410x270.jpg" src="https://flex-home.botble.com/storage/properties/t3-410x270.jpg" alt="Nice Apartment for rent in Berlin" class="thumb">
					</div>
				...
				<h2><a href="https://flex-home.botble.com/properties/nice-apartment-for-rent-in-berlin">Vinhomes Grand Park</a></h2> 
  ...
  <form action="https://flex-home.botble.com/projects" method="get">
	...
	<option value="">-- Select --</option> <option value="1">Căn hộ</option> 
	...
	<input type="number" name="max_flat" id="max_flat" value="" class="form-control"></div></div></div> 
  ...
  <form action="https://flex-home.botble.com/projects" method="get">
	...
	<div class="boxright"><h5>Dự án các khu vực</h5> 
	<ul class="listnews"><li><a href="https://flex-home.botble.com/building-materials" class="text-dark">Quận 1</a></li> 
	<li><a href="https://flex-home.botble.com/house-design" class="text-dark">Quận 2</a></li> <li><a href="https://flex-home.botble.com/house-architecture" class="text-dark">House architecture</a></li> <li><a href="https://flex-home.botble.com/category-news" class="text-dark">News</a></li></ul></div>
	</div>
	</div>
</div>
</p>
            ...
            <div class="areahome">
                ...
                <div style="position:relative;">
                    <div class="owl-carousel" id="project-city-slides">
                                ...
                                <a href="https://flex-home.botble.com/projects/city/alhambra"><img src="https://flex-home.botble.com/storage/cities/los-angeles-winter-2016-410x270.jpg"
                                                                                                  alt="Alhambra"><h4>Alhambra</h4>
                                </a>
                            </div>
                                                    <div class="item itemarea">
                                <a href="https://flex-home.botble.com/projects/city/oakland"><img src="https://flex-home.botble.com/storage/cities/oaklandnightskylineandlakemerritt-410x270.jpg"
                                                                                                  alt="Oakland"><h4>Oakland</h4>
                                </a>
                            </div>
                                                    <div class="item itemarea">
                                <a href="https://flex-home.botble.com/projects/city/bakersfield"><img src="https://flex-home.botble.com/storage/cities/2009-0726-ca-bakersfield-truxtontower-410x270.jpg"
                                                                                                  alt="Bakersfield"><h4>Bakersfield</h4>
                                </a>
                            </div>
                                                    <div class="item itemarea">
                                <a href="https://flex-home.botble.com/projects/city/anaheim"><img src="https://flex-home.botble.com/storage/cities/castillo-de-disneyland-410x270.jpg"
                                                                                                  alt="Anaheim"><h4>Anaheim</h4>
                                </a>
                            </div>
                                                    <div class="item itemarea">
                                <a href="https://flex-home.botble.com/projects/city/san-francisco"><img src="https://flex-home.botble.com/storage/cities/goldengatebridge-001-410x270.jpg"
