                    ...
                    <div class="row">
                        <div class="col-sm-6 lineheight220">
                            <div><span>Status:</span> <b>Selling</b></div>
                             <div><span>Category:</span> <b>Villa</b></div>                              <div><span>Investor:</span> <b>Ping An</b></div>                                                     </div>
                        <div class="col-sm-6 lineheight220">
                             <div><span>Number of blocks:</span> <b>2</b></div>                              <div><span>Number of floors:</span> <b>4</b></div>                             <div><span>Number of flats:</span> <b>125</b></div>                        </div>
                    </div>
...
<ul>
                    ...
                    <div class="mapouter">
                        <div class="gmap_canvas">
                            <iframe id="gmap_canvas" width="100%" height="500"
                                    src="https://maps.google.com/maps?q=Singapore+Island%2C+Singapore%20&t=&z=13&ie=UTF8&iwloc=&output=embed"
    ...
    <div class="form-group">
        <textarea name="content" class="form-control" rows="5" placeholder="Message"></textarea>
            ...
            <div class="form-group">
            <script src="https://www.google.com/recaptcha/api.js?hl=en" async defer></script><div class="g-recaptcha" theme="light" id="buzzNoCaptchaId_042f3122864076d00e5d7cacaa89d150" data-sitekey="6LcjXnAUAAAAABn6hzo7WpoEKkg_we777yg-mK4-"></div>
        </div>
        <div class="form-group">
