{{-- <div class="home_banner" style="background-image: url(img/banner.jpg)">
            <div class="topsearch">
                    ...
                    <div class="typesearch" id="hometypesearch">
                     ...
                     .,mnbvcxer789   <a href="javascript:void(0)" rel="rent" data-url="https://bdsnew.eso.vnproperties">Rent</a>
                    </div>
                    <div class="input-group input-group-lg">
	                    
	                    <div class="form-group"><select name="blocks" id="select-blocks" class="form-control"><option value="">-- Tỉnh, Thành Phố --</option> <option value="1">TP.HCM</option> <option value="2">Bình Dương</option> <option value="3">Đồng Nai</option> <option value="4">Bà Rịa - Vũng Tàu</option></select></div>
	                    
                        <div class="input-group-prepend">
                            <span class="input-group-text"><img src="img/search_icon.png" alt="search"></span>
                        </div>
        ...
        <div class="container-fluid w90">
            <div class="projecthome">
                ...
                <div class="row rowm10">
                            ...
                            <div class="item">
                                <div class="blii">
                                    <div class="img"><img class="thumb" data-src="img/1-410x270.jpg" src="img/1-410x270.jpg" alt="Walnut Park Apartments">
                                    </div>
                            ...
                            <div class="item">
                                <div class="blii">
                                    <div class="img"><img class="thumb" data-src="img/21-410x270.jpg" src="img/21-410x270.jpg" alt="Osaka Heights">
                                    </div>
                            ...
                            <div class="item">
                                <div class="blii">
                                    <div class="img"><img class="thumb" data-src="img/13-410x270.jpg" src="img/13-410x270.jpg" alt="Mimaroba Paradise">
                                    </div>
                            ...
                            <div class="item">
                                <div class="blii">
                                    <div class="img"><img class="thumb" data-src="img/a5-1-410x270.jpg" src="img/a5-1-410x270.jpg" alt="Aegean Villas">
                                    </div>
            ...
            <div class="areahome">
                ...
                <div style="position:relative;">
                    <div class="owl-carousel" id="project-city-slides">
                                ...
                                <a href="https://bdsnew.eso.vnprojects/city/alhambra"><img src="img/los-angeles-winter-2016-410x270.jpg"
                                                                                                  alt="Alhambra"><h4>Alhambra</h4>
                                </a>
                            </div>
                                                    <div class="item itemarea">
                                <a href="https://bdsnew.eso.vnprojects/city/oakland"><img src="img/oaklandnightskylineandlakemerritt-410x270.jpg"
                                                                                                  alt="Oakland"><h4>Oakland</h4>
                                </a>
                            </div>
                                                    <div class="item itemarea">
                                <a href="https://bdsnew.eso.vnprojects/city/bakersfield"><img src="img/2009-0726-ca-bakersfield-truxtontower-410x270.jpg"
                                                                                                  alt="Bakersfield"><h4>Bakersfield</h4>
                                </a>
                            </div>
                                                    <div class="item itemarea">
                                <a href="https://bdsnew.eso.vnprojects/city/anaheim"><img src="img/castillo-de-disneyland-410x270.jpg"
                                                                                                  alt="Anaheim"><h4>Anaheim</h4>
                                </a>
                            </div>
                                                    <div class="item itemarea">
                                <a href="https://bdsnew.eso.vnprojects/city/san-francisco"><img src="img/goldengatebridge-001-410x270.jpg"
                                                                                                  alt="San Francisco"><h4>San Francisco</h4>
                                </a>
                            </div>
                                            </div>
                    <i class="am-next"><img src="img/aleft.png" alt="pre"></i>
                    <i class="am-prev"><img src="img/aright.png" alt="next"></i>
                </div>
            </div>
    ...
    <div class="box_shadow">
        ...
        <div class="container-fluid w90">
            <div class="homehouse">
				...
				<div class="row rowm10"><!----> <!----> <div class="col-sm-4 col-md-3 colm10"><div class="hourseitem"><div class="blii"><div class="img"><img data-src="img/6-2-410x270.jpg" src="img/6-2-410x270.jpg" alt="5 room luxury penthouse for sale in Kuala Lumpur" class="thumb"></div> <a href="https://bdsnew.eso.vnproperties/villa-for-sale-in-lavanya-residences" class="linkdetail"></a> <div class="status"><span class="label-success status-label">Selling</span></div></div> <div class="info"><h3><a href="https://bdsnew.eso.vnproperties/villa-for-sale-in-lavanya-residences">5 room luxury penthouse for sale in Kuala Lumpur</a></h3> <p class="city"><i class="fas fa-map-marker-alt" style="opacity: 0.7;"></i>  Kuala Lumpur, Malaysia</p> <p class="bold500">Price: $1.59 million  </p> <p class="threemt bold500"><span data-toggle="tooltip" data-placement="top" data-original-title="Number of rooms"><i><img src="img/bed.svg" alt="icon"></i> <i class="vti">5</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Number of rest rooms"><i><img src="img/bath.svg" alt="icon"></i> <i class="vti">7</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Square"><i><img src="img/area.svg" alt="icon"></i> <i class="vti">377 m2</i></span></p></div></div></div><div class="col-sm-4 col-md-3 colm10"><div class="hourseitem"><div class="blii"><div class="img"><img data-src="img/5-2-410x270.jpg" src="img/5-2-410x270.jpg" alt="Luxury Apartments in Singapore for Sale" class="thumb"></div> <a href="https://bdsnew.eso.vnproperties/the-avila-apartment" class="linkdetail"></a> <div class="status"><span class="label-success status-label">Selling</span></div></div> <div class="info"><h3><a href="https://bdsnew.eso.vnproperties/the-avila-apartment">Luxury Apartments in Singapore for Sale</a></h3> <p class="city"><i class="fas fa-map-marker-alt" style="opacity: 0.7;"></i>  Balestier Road, Singapore</p> <p class="bold500">Price: $918,000 </p> <p class="threemt bold500"><span data-toggle="tooltip" data-placement="top" data-original-title="Number of rooms"><i><img src="img/bed.svg" alt="icon"></i> <i class="vti">2</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Number of rest rooms"><i><img src="img/bath.svg" alt="icon"></i> <i class="vti">2</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Square"><i><img src="img/area.svg" alt="icon"></i> <i class="vti">78 m2</i></span></p></div></div></div><div class="col-sm-4 col-md-3 colm10"><div class="hourseitem"><div class="blii"><div class="img"><img data-src="img/79-410x270.jpg" src="img/79-410x270.jpg" alt="Private Estate Magnificent Views" class="thumb"></div> <a href="https://bdsnew.eso.vnproperties/private-estate-magnificent-views" class="linkdetail"></a> <div class="status"><span class="label-success status-label">Selling</span></div></div> <div class="info"><h3><a href="https://bdsnew.eso.vnproperties/private-estate-magnificent-views">Private Estate Magnificent Views</a></h3> <p class="city"><i class="fas fa-map-marker-alt" style="opacity: 0.7;"></i>  110 Springdale Heights, Hay Denmark, WA, Australia</p> <p class="bold500">Price: $694,000 </p> <p class="threemt bold500"><span data-toggle="tooltip" data-placement="top" data-original-title="Number of rooms"><i><img src="img/bed.svg" alt="icon"></i> <i class="vti">3</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Number of rest rooms"><i><img src="img/bath.svg" alt="icon"></i> <i class="vti">1</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Square"><i><img src="img/area.svg" alt="icon"></i> <i class="vti">2000 m2</i></span></p></div></div></div><div class="col-sm-4 col-md-3 colm10"><div class="hourseitem"><div class="blii"><div class="img"><img data-src="img/24-1-410x270.jpg" src="img/24-1-410x270.jpg" alt="Osaka Heights Apartment" class="thumb"></div> <a href="https://bdsnew.eso.vnproperties/osaka-heights-apartment" class="linkdetail"></a> <div class="status"><span class="label-success status-label">Selling</span></div></div> <div class="info"><h3><a href="https://bdsnew.eso.vnproperties/osaka-heights-apartment">Osaka Heights Apartment</a></h3> <p class="city"><i class="fas fa-map-marker-alt" style="opacity: 0.7;"></i>  High Level Road, Colombo 06, Sri Lanka</p> <p class="bold500">Price: $150,000 </p> <p class="threemt bold500"><span data-toggle="tooltip" data-placement="top" data-original-title="Number of rooms"><i><img src="img/bed.svg" alt="icon"></i> <i class="vti">2</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Number of rest rooms"><i><img src="img/bath.svg" alt="icon"></i> <i class="vti">2</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Square"><i><img src="img/area.svg" alt="icon"></i> <i class="vti">110 m2</i></span></p></div></div></div><div class="col-sm-4 col-md-3 colm10"><div class="hourseitem"><div class="blii"><div class="img"><img data-src="img/411-410x270.jpg" src="img/411-410x270.jpg" alt="Villa for sale at Bermuda Dunes" class="thumb"></div> <a href="https://bdsnew.eso.vnproperties/42460-buccaneer-court" class="linkdetail"></a> <div class="status"><span class="label-success status-label">Selling</span></div></div> <div class="info"><h3><a href="https://bdsnew.eso.vnproperties/42460-buccaneer-court">Villa for sale at Bermuda Dunes</a></h3> <p class="city"><i class="fas fa-map-marker-alt" style="opacity: 0.7;"></i>  Bermuda Dunes, Riverside County, CA 92203, USA</p> <p class="bold500">Price: $1.30 million  </p> <p class="threemt bold500"><span data-toggle="tooltip" data-placement="top" data-original-title="Number of rooms"><i><img src="img/bed.svg" alt="icon"></i> <i class="vti">4</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Number of rest rooms"><i><img src="img/bath.svg" alt="icon"></i> <i class="vti">3</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Square"><i><img src="img/area.svg" alt="icon"></i> <i class="vti">480 m2</i></span></p></div></div></div><div class="col-sm-4 col-md-3 colm10"><div class="hourseitem"><div class="blii"><div class="img"><img data-src="img/31-410x270.jpg" src="img/31-410x270.jpg" alt="Stunning French Inspired Manor" class="thumb"></div> <a href="https://bdsnew.eso.vnproperties/stunning-french-inspired-manor" class="linkdetail"></a> <div class="status"><span class="label-success status-label">Selling</span></div></div> <div class="info"><h3><a href="https://bdsnew.eso.vnproperties/stunning-french-inspired-manor">Stunning French Inspired Manor</a></h3> <p class="city"><i class="fas fa-map-marker-alt" style="opacity: 0.7;"></i>  Solvang, Santa Barbara County, CA 93463, USA</p> <p class="bold500">Price: $1.70 million  </p> <p class="threemt bold500"><span data-toggle="tooltip" data-placement="top" data-original-title="Number of rooms"><i><img src="img/bed.svg" alt="icon"></i> <i class="vti">4</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Number of rest rooms"><i><img src="img/bath.svg" alt="icon"></i> <i class="vti">3</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Square"><i><img src="img/area.svg" alt="icon"></i> <i class="vti">450 m2</i></span></p></div></div></div><div class="col-sm-4 col-md-3 colm10"><div class="hourseitem"><div class="blii"><div class="img"><img data-src="img/23-410x270.jpeg" src="img/23-410x270.jpeg" alt="Property For sale , Johannesburg, South Africa" class="thumb"></div> <a href="https://bdsnew.eso.vnproperties/property-for-sale-johannesburg-south-africa" class="linkdetail"></a> <div class="status"><span class="label-success status-label">Selling</span></div></div> <div class="info"><h3><a href="https://bdsnew.eso.vnproperties/property-for-sale-johannesburg-south-africa">Property For sale , Johannesburg, South Africa</a></h3> <p class="city"><i class="fas fa-map-marker-alt" style="opacity: 0.7;"></i>  Johannesburg, South Africa</p> <p class="bold500">Price: $800,000 </p> <p class="threemt bold500"><span data-toggle="tooltip" data-placement="top" data-original-title="Number of rooms"><i><img src="img/bed.svg" alt="icon"></i> <i class="vti">4</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Number of rest rooms"><i><img src="img/bath.svg" alt="icon"></i> <i class="vti">4</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Square"><i><img src="img/area.svg" alt="icon"></i> <i class="vti">800 m2</i></span></p></div></div></div><div class="col-sm-4 col-md-3 colm10"><div class="hourseitem"><div class="blii"><div class="img"><img data-src="img/1-410x270.jpg" src="img/1-410x270.jpg" alt="3 Beds Villa Calpe, Alicante" class="thumb"></div> <a href="https://bdsnew.eso.vnproperties/3-beds-villa-calpe-alicante" class="linkdetail"></a> <div class="status"><span class="label-success status-label">Selling</span></div></div> <div class="info"><h3><a href="https://bdsnew.eso.vnproperties/3-beds-villa-calpe-alicante">3 Beds Villa Calpe, Alicante</a></h3> <p class="city"><i class="fas fa-map-marker-alt" style="opacity: 0.7;"></i>  Alicante, Spain</p> <p class="bold500">Price: $700,000 </p> <p class="threemt bold500"><span data-toggle="tooltip" data-placement="top" data-original-title="Number of rooms"><i><img src="img/bed.svg" alt="icon"></i> <i class="vti">3</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Number of rest rooms"><i><img src="img/bath.svg" alt="icon"></i> <i class="vti">3</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Square"><i><img src="img/area.svg" alt="icon"></i> <i class="vti">600 m2</i></span></p></div></div></div></div>
...
<p><div class="container-fluid w90">
    <div class="homehouse padtop30">
		...
		<div class="row rowm10"><!----> <!----> <div class="col-sm-4 col-md-3 colm10"><div class="hourseitem"><div class="blii"><div class="img"><img data-src="img/t3-410x270.jpg" src="img/t3-410x270.jpg" alt="Nice Apartment for rent in Berlin" class="thumb"></div> <a href="https://bdsnew.eso.vnproperties/nice-apartment-for-rent-in-berlin" class="linkdetail"></a> <div class="status"><span class="label-success status-label">Renting</span></div></div> <div class="info"><h3><a href="https://bdsnew.eso.vnproperties/nice-apartment-for-rent-in-berlin">Nice Apartment for rent in Berlin</a></h3> <p class="city"><i class="fas fa-map-marker-alt" style="opacity: 0.7;"></i>  Berlin, Germany</p> <p class="bold500">Price: $1,217 / month </p> <p class="threemt bold500"><span data-toggle="tooltip" data-placement="top" data-original-title="Number of rooms"><i><img src="img/bed.svg" alt="icon"></i> <i class="vti">1</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Number of rest rooms"><i><img src="img/bath.svg" alt="icon"></i> <i class="vti">1</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Square"><i><img src="img/area.svg" alt="icon"></i> <i class="vti">33 m2</i></span></p></div></div></div><div class="col-sm-4 col-md-3 colm10"><div class="hourseitem"><div class="blii"><div class="img"><img data-src="img/b4-1-410x270.jpg" src="img/b4-1-410x270.jpg" alt="Apartment Muiderstraatweg in Diemen" class="thumb"></div> <a href="https://bdsnew.eso.vnproperties/apartment-muiderstraatweg-in-diemen" class="linkdetail"></a> <div class="status"><span class="label-success status-label">Renting</span></div></div> <div class="info"><h3><a href="https://bdsnew.eso.vnproperties/apartment-muiderstraatweg-in-diemen">Apartment Muiderstraatweg in Diemen</a></h3> <p class="city"><i class="fas fa-map-marker-alt" style="opacity: 0.7;"></i>  Diemen, Netherlands</p> <p class="bold500">Price: $2,123 / month </p> <p class="threemt bold500"><span data-toggle="tooltip" data-placement="top" data-original-title="Number of rooms"><i><img src="img/bed.svg" alt="icon"></i> <i class="vti">3</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Number of rest rooms"><i><img src="img/bath.svg" alt="icon"></i> <i class="vti">1</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Square"><i><img src="img/area.svg" alt="icon"></i> <i class="vti">90 m2</i></span></p></div></div></div><div class="col-sm-4 col-md-3 colm10"><div class="hourseitem"><div class="blii"><div class="img"><img data-src="img/a1-2-410x270.jpg" src="img/a1-2-410x270.jpg" alt="2 Floor house in Compound Pejaten Barat Kemang" class="thumb"></div> <a href="https://bdsnew.eso.vnproperties/want-to-lease-a-house-in-compound-pejaten-barat-kemang" class="linkdetail"></a> <div class="status"><span class="label-success status-label">Renting</span></div></div> <div class="info"><h3><a href="https://bdsnew.eso.vnproperties/want-to-lease-a-house-in-compound-pejaten-barat-kemang">2 Floor house in Compound Pejaten Barat Kemang</a></h3> <p class="city"><i class="fas fa-map-marker-alt" style="opacity: 0.7;"></i>  Kota Administrasi Jakarta Selatan, South Jakarta City, Jakarta Raya, Indonesia</p> <p class="bold500">Price: $1,400 / month </p> <p class="threemt bold500"><span data-toggle="tooltip" data-placement="top" data-original-title="Number of rooms"><i><img src="img/bed.svg" alt="icon"></i> <i class="vti">3</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Number of rest rooms"><i><img src="img/bath.svg" alt="icon"></i> <i class="vti">2</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Square"><i><img src="img/area.svg" alt="icon"></i> <i class="vti">200 m2</i></span></p></div></div></div><div class="col-sm-4 col-md-3 colm10"><div class="hourseitem"><div class="blii"><div class="img"><img data-src="img/a1-1-410x270.jpg" src="img/a1-1-410x270.jpg" alt="Elegant family home presents premium modern living" class="thumb"></div> <a href="https://bdsnew.eso.vnproperties/elegant-family-home-presents-premium-modern-living" class="linkdetail"></a> <div class="status"><span class="label-success status-label">Renting</span></div></div> <div class="info"><h3><a href="https://bdsnew.eso.vnproperties/elegant-family-home-presents-premium-modern-living">Elegant family home presents premium modern living</a></h3> <p class="city"><i class="fas fa-map-marker-alt" style="opacity: 0.7;"></i>  North Lakes QLD 4509, Australia</p> <p class="bold500">Price: $1,574 / month </p> <p class="threemt bold500"><span data-toggle="tooltip" data-placement="top" data-original-title="Number of rooms"><i><img src="img/bed.svg" alt="icon"></i> <i class="vti">3</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Number of rest rooms"><i><img src="img/bath.svg" alt="icon"></i> <i class="vti">3</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Square"><i><img src="img/area.svg" alt="icon"></i> <i class="vti">658 m2</i></span></p></div></div></div><div class="col-sm-4 col-md-3 colm10"><div class="hourseitem"><div class="blii"><div class="img"><img data-src="img/12-410x270.jpg" src="img/12-410x270.jpg" alt="Brand New 1 Bedroom Apartment In First Class Location" class="thumb"></div> <a href="https://bdsnew.eso.vnproperties/break-lease-available" class="linkdetail"></a> <div class="status"><span class="label-success status-label">Renting</span></div></div> <div class="info"><h3><a href="https://bdsnew.eso.vnproperties/break-lease-available">Brand New 1 Bedroom Apartment In First Class Location</a></h3> <p class="city"><i class="fas fa-map-marker-alt" style="opacity: 0.7;"></i>  Sandy Bay Road, Sandy Bay TAS, Australia</p> <p class="bold500">Price: $1,680 / month </p> <p class="threemt bold500"><span data-toggle="tooltip" data-placement="top" data-original-title="Number of rooms"><i><img src="img/bed.svg" alt="icon"></i> <i class="vti">1</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Number of rest rooms"><i><img src="img/bath.svg" alt="icon"></i> <i class="vti">1</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Square"><i><img src="img/area.svg" alt="icon"></i> <i class="vti">80 m2</i></span></p></div></div></div><div class="col-sm-4 col-md-3 colm10"><div class="hourseitem"><div class="blii"><div class="img"><img data-src="img/5-1-410x270.jpg" src="img/5-1-410x270.jpg" alt="Thompsons Road House for rent" class="thumb"></div> <a href="https://bdsnew.eso.vnproperties/harry-baskervilles-hay-loft" class="linkdetail"></a> <div class="status"><span class="label-success status-label">Renting</span></div></div> <div class="info"><h3><a href="https://bdsnew.eso.vnproperties/harry-baskervilles-hay-loft">Thompsons Road House for rent</a></h3> <p class="city"><i class="fas fa-map-marker-alt" style="opacity: 0.7;"></i>  Thompsons Road, Bulleen VIC, Australia</p> <p class="bold500">Price: $1,465 / month </p> <p class="threemt bold500"><span data-toggle="tooltip" data-placement="top" data-original-title="Number of rooms"><i><img src="img/bed.svg" alt="icon"></i> <i class="vti">3</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Number of rest rooms"><i><img src="img/bath.svg" alt="icon"></i> <i class="vti">3</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Square"><i><img src="img/area.svg" alt="icon"></i> <i class="vti">160 m2</i></span></p></div></div></div><div class="col-sm-4 col-md-3 colm10"><div class="hourseitem"><div class="blii"><div class="img"><img data-src="img/b5-410x270.jpg" src="img/b5-410x270.jpg" alt="Family Victorian &quot;View&quot; Home" class="thumb"></div> <a href="https://bdsnew.eso.vnproperties/family-victorian-view-home" class="linkdetail"></a> <div class="status"><span class="label-success status-label">Renting</span></div></div> <div class="info"><h3><a href="https://bdsnew.eso.vnproperties/family-victorian-view-home">Family Victorian "View" Home</a></h3> <p class="city"><i class="fas fa-map-marker-alt" style="opacity: 0.7;"></i>  Safeway San Francisco CA, Market Street, San Francisco, CA 94114, USA</p> <p class="bold500">Price: $2,580 / month </p> <p class="threemt bold500"><span data-toggle="tooltip" data-placement="top" data-original-title="Number of rooms"><i><img src="img/bed.svg" alt="icon"></i> <i class="vti">3</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Number of rest rooms"><i><img src="img/bath.svg" alt="icon"></i> <i class="vti">2</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Square"><i><img src="img/area.svg" alt="icon"></i> <i class="vti">180 m2</i></span></p></div></div></div><div class="col-sm-4 col-md-3 colm10"><div class="hourseitem"><div class="blii"><div class="img"><img data-src="img/a3-410x270.jpg" src="img/a3-410x270.jpg" alt="5 beds luxury house" class="thumb"></div> <a href="https://bdsnew.eso.vnproperties/el-camino-del-mar" class="linkdetail"></a> <div class="status"><span class="label-success status-label">Renting</span></div></div> <div class="info"><h3><a href="https://bdsnew.eso.vnproperties/el-camino-del-mar">5 beds luxury house</a></h3> <p class="city"><i class="fas fa-map-marker-alt" style="opacity: 0.7;"></i>  Seacliff San Francisco, Sea Cliff Avenue, San Francisco, CA 94121, USA</p> <p class="bold500">Price: $1,808 / month </p> <p class="threemt bold500"><span data-toggle="tooltip" data-placement="top" data-original-title="Number of rooms"><i><img src="img/bed.svg" alt="icon"></i> <i class="vti">5</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Number of rest rooms"><i><img src="img/bath.svg" alt="icon"></i> <i class="vti">4</i></span> <span data-toggle="tooltip" data-placement="top" data-original-title="Square"><i><img src="img/area.svg" alt="icon"></i> <i class="vti">270 m2</i></span></p></div></div></div></div>
		...
		<div class="col-sm-6 col-md-6 colm10 itemduan">
			<div class="hourseitem row">
				<div class="blii col-sm-6 col-md-6 colm10">
					<div class="img">
						<img data-src="img/t3-410x270.jpg" src="img/t3-410x270.jpg" alt="Nice Apartment for rent in Berlin" class="thumb">
					</div>
			...
			<div class="hinhpost col-sm-6 col-md-6">
				<div class="img"><img data-src="img/t3-410x270.jpg" src="img/t3-410x270.jpg" alt="Nice Apartment for rent in Berlin" class="thumb"></div>
				<a href="https://bdsnew.eso.vnproperties/nice-apartment-for-rent-in-berlin" class="linkdetail"></a> 
				...
				<img src="img/area.svg" alt="icon"></i> 
