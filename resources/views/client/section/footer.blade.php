<div class="container">
    <div class="row">
        ...
        <div class="col-3 pt-4">
            <h3 class="mt-3 mb-2 fw-bold">Dich vu</h3>
        ...
        <div class="col-3 pt-4">
            <h3 class="my-3 fw-bold">Lien He</h3>
    ...
    <div class="row">
        ...
        <div class="col-6 text-right re-footer-text-muted">
            <a href="#" class="text-info fw-bold">Dieu khoan</a>
            va
            <a href="#" class="text-info fw-bold">Chinh sach</a>
        </div>
    </div>
</div>
