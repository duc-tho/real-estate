<form enctype="multipart/form-data" id="main"
    action="{{ Request::is('admin/project/add') ? route('adminProjectPostAdd') : route('adminProjectPutEdit', $data['project_info']->ProjectId) }}"
    method="post">
    @csrf
            ...
            <div class="tab-content">
                <div class="tab-pane active container" id="basicInfo">
                    <div class="form-group d-flex">
                        ...
                        <div class="w-100">
                            <input id="title" class="form-control" type="text" placeholder="Tên Dự Án" name="Title"
                                value="{{ $data['project_info']->Title ?? old('Title') }}">
                    ...
                    <div class="form-group d-flex">
                        ...
                        <div class="w-100">
                            <input id="location" class="form-control" type="text" placeholder="Địa Chỉ" name="Location"
                                value="{{ $data['project_info']->Location ?? old('Location') }}">
                            <div class="col-lg-12 messages text-danger"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group d-flex">
                        ...
                        <div class="w-100">
                            <input id="investor" class="form-control" type="text" placeholder="Chủ Đầu Tư"
                                name="Investor" value="{{ $data['project_info']->Investor ?? old('Investor') }}">
                            <div class="col-lg-12 messages text-danger"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group d-flex">
                        ...
                        <div class="w-100">
                            <input id="block" class="form-control" type="text" placeholder="Số Block"
                                name="NumberOfBlock"
                                value="{{ $data['project_info']->NumberOfBlock ?? old('NumberOfBlock') }}">
                            <div class="col-lg-12 messages text-danger"></div>
                        </div>

                        <label class="col-sm-2" for="name" style="padding-top: 7px;">Số Floor</label>
                        <div class="w-100">
                            <input id="floor" class="form-control" type="text" placeholder="Số Floor"
                                name="NumberOfFloor"
                                value="{{ $data['project_info']->NumberOfFloor ?? old('NumberOfFloor') }}">
                            <div class="col-lg-12 messages text-danger"></div>
                        </div>
                        ...
                        <div class="w-100">
                            <input id="apartment" class="form-control" type="text" placeholder="Số Căn Hộ"
                                name="NumberOfApartment"
                                value="{{ $data['project_info']->NumberOfApartment ?? old('NumberOfApartment') }}">
                            <div class="col-lg-12 messages text-danger"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group d-flex">
                        ...
                        <div class="w-100">
                            <input id="apartment" class="form-control" type="text" placeholder="Số Căn Hộ"
                                name="AreaApartment"
                                value="{{ $data['project_info']->AreaApartment ?? old('AreaApartment') }}">
                            <div class="col-lg-12 messages text-danger"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group d-flex">
                        ...
                        <div class="w-100">
                            <input id="totalarea" class="form-control" type="text" placeholder="Tổng Diện Tích"
                                name="TotalArea" value="{{ $data['project_info']->TotalArea ?? old('TotalArea') }}">
                            <div class="col-lg-12 messages text-danger"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group d-flex">
                        ...
                        <div class="w-100">
                            <input id="density" class="form-control" type="text" placeholder="Mật độ"
                                name="BuildingDensity"
                                value="{{ $data['project_info']->BuildingDensity ?? old('BuildingDensity') }}">
                            <div class="col-lg-12 messages text-danger"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group d-flex">
                        ...
                        <div class="w-100">
                            <input id="year" class="form-control" type="text" placeholder="Năm Xây Dựng"
                                name="YearBuilt" value="{{ $data['project_info']->YearBuilt ?? old('YearBuilt') }}">
                            <div class="col-lg-12 messages text-danger"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group d-flex">
                        ...
                        <div class="w-100">
                            <input id="price" class="form-control" type="text" placeholder="Giá" name="Price"
                                value="{{ $data['project_info']->Price ?? old('Price  ') }}">
                            <div class="col-lg-12 messages text-danger"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group d-flex">
                        ...
                        <div class="w-100">
                            <input id="slug" class="form-control" type="text" placeholder="" name="Slug"
                ...
                <div class="tab-pane container" id="vtht">
                    <div class="form-group">
                        <div class="md-form">
                            <textarea id="InfrastructureLocation" name="InfrastructureLocation"
                                class="md-textarea form-control"
                                rows="10">{{ $data['project_info']->InfrastructureLocation ?? old('InfrastructureLocation') }}</textarea>
                        </div>
                        <div class=" col-lg-12 messages text-danger"></div>
                    </div>
                </div>
                ...
                <div class="tab-pane container" id="tkmb">
                    <div class="form-group">
                        <div class="md-form">
                            <textarea id="GroundDesign" name="GroundDesign" class="md-textarea form-control"
                                rows="10">{{ $data['project_info']->GroundDesign ?? old('GroundDesign') }}</textarea>
                        </div>
                        <div class=" col-lg-12 messages text-danger"></div>
                    </div>
                </div>
                ...
                <div class="tab-pane container" id="tikm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="md-form">
                            <textarea id="Promotion" name="Promotion" class="md-textarea form-control"
                                rows="10">{{ $data['project_info']->Promotion ?? old('Promotion') }}</textarea>
                        </div>
                        <div class=" col-lg-12 messages text-danger"></div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="input-group mb-3">
                                <div class="custom-file">
                                    <input multiple type="file" name="Image[]" class="custom-file-input"
                                        id="inputImageFile">
                                    <label class="custom-file-label" for="inputImageFile"
                                        style="white-space: nowrap; overflow: hidden;">Bấm vào để chọn ảnh</label>
                                </div>
                            </div>
                            <div class="row">
                                            ...
                                            @if (explode('|', $data['project_info']->Image)[$i] !== '')
                                                <figure class="col-md-4">
                                                    <div class="w-100" style="height: 300px; position: relative;">
                                                        <img alt="picture"
                                                            src="{{ asset(explode('|', $data['project_info']->Image)[$i]) }}"
                                                            style="position: absolute; top: 0; left: 0; bottom: 0; right: 0; margin: auto; max-height: 100%; max-width: 100%" />
                                                    </div>
                                                </figure>
                                            @endif
                                        @endfor
