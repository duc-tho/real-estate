...
class ProjectController extends Controller
{
    ...
    public function projectDetail($slug)
    {
        ...
        $projectDetail->Ward = Street::find($projectDetail->StreetId)->Ward;
        $projectDetail->District = Ward::find($projectDetail->Ward->AreaId)->District;
        ...
        if (!empty($projectDetail->post_rent_list)) {
            foreach ($projectDetail->post_rent_list as $item) {
                ...
                $item->Ward = Street::find($item->StreetId)->Ward;
                $item->District = Ward::find($item->Ward->AreaId)->District;
